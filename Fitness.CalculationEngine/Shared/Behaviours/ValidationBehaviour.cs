...
using MediatR;
using ValidationException = Fitness.CalculationEngine.Shared.Exceptions.ValidationException;

namespace Fitness.CalculationEngine.Shared.Behaviours;
    ...
    where TRequest : IRequest<TResponse>
{
        ...
        RequestHandlerDelegate<TResponse> next, CancellationToken cancellationToken)
    {
        ...
        if (failures.Any())
        {
            throw new ValidationException(failures); // ← JUST THROW, don't try to create response
        }
